...
export type GetCurrentUserQuery = { __typename?: 'Query', getCurrentUser?: { __typename?: 'User', email: string, id: string, firstName: string, lastName?: string | null, profileImageUrl?: string | null } | null };
